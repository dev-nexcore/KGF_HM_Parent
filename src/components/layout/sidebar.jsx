...
//         <aside
//           className={`
//             fixed top-0 left-0 min-h-full bg-[#A4B494] py-6 flex flex-col justify-between rounded-tr-3xl shadow-lg
//             transform transition-transform duration-300 ease-in-out
//             z-40
//             w-48 sm:w-60 md:w-60
//             md:static md:translate-x-0 md:rounded-tr-4xl md:shadow md:sticky md:top-0 md:h-screen md:overflow-hidden
...
//                   alt="Logo"
//                 /> */}
//                 <Image src={logo1} alt="logo" className="h-12 w-12 md:h-16 md:w-16 object-contain" />
//               </div>
//             </div>
//           </div>
